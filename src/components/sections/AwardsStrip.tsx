        ...
        <ScrollReveal>
          <div className="text-center mb-10 md:mb-14">
            ...
            <p className="text-[#555555] text-[14px] md:text-[15px] leading-[1.75] max-w-2xl mx-auto mt-5">
              Banton Group — Established in February 2020 by Amanda Banton — is recognised as a{' '}
              ...
              Today, Banton Group is one of Australia's most formidable private litigation and insolvency practices, acting in some of the country's most significant class actions and insolvencies.
            </p>
          </div>
        </ScrollReveal>
      </div>
